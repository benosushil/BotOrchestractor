...
namespace Microsoft.BotBuilderSamples
{
    public class BotServices : IBotServices
    {
        public BotServices(IConfiguration configuration, OrchestratorRecognizer dispatcher)
        {
            ...
            LuisHRRecognizer = CreateLuisRecognizer(configuration, "LuisHRAppId", "LuisHRKey", "LuisHRAPIHostName");
            LuisWeatherRecognizer = CreateLuisRecognizer(configuration, "LuisHRAppId", "LuisHRKey", "LuisHRAPIHostName");
       ...
       // public QnAMaker SampleQnA { get; private set; }
        ...
        public LuisRecognizer LuisHRRecognizer { get; private set; }

        public LuisRecognizer LuisWeatherRecognizer { get; private set; }

        private LuisRecognizer CreateLuisRecognizer(IConfiguration configuration, string appIdKey, string luisAPIKey, string luisAPIHostName)
        {
